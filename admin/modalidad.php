        ...
        <div class="right_col" role="main">
            <div class="page-title">
              <div class="title_left">
                <h3>Configuración de Modalidad</h3>
              </div>
            ...
            <button type="button" class="btn btn-dark" data-toggle="modal" data-target=".bs-example-modal-lg">Agregar modalidad</button>
                        ...
                        <div class="modal-body">
                          <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="x_panel">
                                <div class="x_title">
                                  <h2>Formulario de modalidad <small>Insertar</small></h2>
                                  <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                  <br />
                                  ...
                                  <form action="clases/insertar_modalidad.php"  data-parsley-validate class="form-horizontal form-label-left" method="POST" autocomplete="off">

                                    <div class="form-group">
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Modalidad</label>

                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" id="last-name" name="txt_descrimod" required="required" class="form-control col-md-7 col-xs-12">
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Estado</label>
                                      <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="txt_estamod">
                                      </div>
                                    </div>
                    ...
                    <div class="x_content">
                     ...
                     <?php
                       ...
                       if (isset($_GET['modalidad_id'])) {
                            require_once('eliminar/eliminar_modadlidad.php');
                       }
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <?php  require_once('consultas/consulta_modalidad.php'); ?>
                        </tbody>
                      </table>
                    </div>
                  </div>
