<?php 
  require_once('./clases/conexion.php');
   ...
   $consulta = $pdo->prepare("SELECT persona_id, dni_persona, nombres_persona, apellidos_persona, carrera.carrera_name, mencion.mencion_mencion, modalidad.modalidad_name, horario_clases.horario ,pais.pais_nombre FROM persona 
